...
* Request
  * Method: GET
  * URL: /users/:userId/spots/:spotId/edit
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /users/:userId/bookings/:bookingId/delete
                  <!-- /spots/:spotId/bookings/bookingId/delete -->
  * Body: none
...
* Request
  * Method: POST
  * URL: /users/:userId/spots/:spotId/images/:imageId/delete
  * Body: none
...
* Request
  * Method: POST
  * URL: /users/:userId/reviews/:reviewId/images/:imageId/delete
  * Body: none
